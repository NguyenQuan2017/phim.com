<div class="hor-menu  hor-menu-light hidden-sm hidden-xs">
   <ul class="nav navbar-nav">
      ...
      <li class="mega-menu-dropdown mega-menu-full hover-initialized">
         <a class="dropdown-toggle hover-initialized" href="javascript:;">Mega <i class="fa fa-angle-down"></i> </a>
      ...
      <li class="classic-menu-dropdown">
         <a data-close-others="true" data-hover="megamenu-dropdown" href="javascript:;" class="hover-initialized"> Classic <i class="fa fa-angle-down"></i> </a>
   ...
   <form method="GET" action="http://adminui-v1.0.bittyfox.com/default/aqua-black/search_results.html" class="search-form search-form-expanded">
      <div class="input-group">
         ...
         <span class="input-group-btn"> <a class="btn submit" href="javascript:;"> <i class="icon-magnifier"></i> </a> </span>                       
      </div>
   </form>
</div>