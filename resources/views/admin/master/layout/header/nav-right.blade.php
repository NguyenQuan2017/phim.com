<ul class="nav navbar-nav pull-right">
      ...
      <ul class="dropdown-menu dropdown-messages menuBig">
         <li>
            <div class="dropdown-messages-box">
               <a class="pull-left" href="profile.html"> <img src="{{url('admin/images/teem/a7.jpg')}}" class="img-circle" alt="image"> </a>
         ...
         <li>
            <div class="dropdown-messages-box">
               <a class="pull-left" href="profile.html"> <img src="{{url('admin/images/teem/a4.jpg')}}" class="img-circle" alt="image"> </a>
         ...
         <li>
            <div class="dropdown-messages-box">
               <a class="pull-left" href="profile.html"> <img src="{{url('admin/images/teem/a3.jpg')}}" class="img-circle" alt="image"> </a>
   ...
   <li class="dropdown dropdown-user">
      <a data-close-others="true" data-hover="dropdown" data-toggle="dropdown" class="dropdown-toggle" href="javascript:;"> <img src="{{url('admin/images/teem/a10.jpg')}}" class="img-circle" alt=""> <span class="username username-hide-on-mobile"> {{$user['name']}}</span> <i class="fa fa-angle-down"></i> </a>
      <ul class="dropdown-menu dropdown-menu-default">
         ...
         <li class="divider"> </li>
         <li>
            <a href="lockscreen.html"> <i class="icon-lock"></i> Lock Screen </a>
         </li>
         <li>
